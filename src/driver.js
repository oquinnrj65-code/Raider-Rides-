...
export async function renderDriver(){
  ...
  await load();
  const rawApiBase=window.RAIDER_RIDES_API_BASE_URL||localStorage.getItem("raiderRidesApiBase")||"https://raider-rides-api.onrender.com/api";const apiBase=rawApiBase.endsWith("/")?rawApiBase.slice(0,-1):rawApiBase;
  try{
